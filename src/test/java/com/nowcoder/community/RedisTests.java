...
public class RedisTests {
    ...
    public void testHyperLogLogUnion() {
        ...
        redisTemplate.opsForHyperLogLog().union(unionKey, redisKey2, redisKey3, redisKey4); // 将redisKey2, redisKey3, redisKey4合并到unionKey
